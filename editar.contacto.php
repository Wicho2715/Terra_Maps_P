...
<div class="container">
    ...
    <div class="card card-body">
      <form action="editar.contacto.php?ID_CONTACTO=<?php echo $_GET['ID_CONTACTO']; ?>" method="POST">
      
        <div class="form-group">
            <div class="row">
              <div class="col-md-6">
                <label for="tipoc">Tipo Contacto:</label> 
                <input name="tipoc" type="text" class="form-control" value="<?php echo $tipoc;?>">
              </div>
              <div class="col-md-6">
                <label for="destinatario">Destinatario:</label> 
                <input name="destinatario" type="text" class="form-control" value="<?php echo $destinatario; ?>">
              </div> 
            </div> 
        </div>
        <div class="form-group">
          <div class="row">
              <div class="col-md-6">
                ...
                <input name="asunto" type="text" class="form-control" value="<?php echo $asunto;?>">
              </div>
              <div class="col-md-6">
                <label for="resumen">Resumen:</label> 
                <input name="resumen" type="text" class="form-control" value="<?php echo $resumen; ?>">
              </div> 
          </div>
        </div>
        <div class="form-group">
          <div class="row">
              ...
              <div class="col-md-6">
                ...
                <input name="nombrec" type="text" class="form-control" value="<?php echo $nombrec; ?>">
              </div> 
          </div> 
        </div>
        <div class="form-group">
          <div class="row">
              <div class="col-md-6">
                ...
                <input name="acuerdo" type="text" class="form-control" value="<?php echo $acuerdo;?>">
              </div>
          </div> 
        </div>
        <div class="row">
